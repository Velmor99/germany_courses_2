  ...
  return (
    <div className={cn(styles["our-advantages"])}>
      <div className={cn(styles["container"])}>
        ...
        <ul className={cn(styles["our-advantages__list"], {
          [styles["our-advantages__list-documents"]]: imageType === "documents"
        })}>
          {imageType === "documents" ? (
            <>
              <li className={cn(styles["our-advantages__list-item"], styles["our-advantages__list-item-documnets"])}>
                <AdvantagesDocumentsCard className={cn(styles["card-background"], styles["card-background-first"])} text={t("our_advantages_documents.1.text")} optionText={{
              ...
              <li className={cn(styles["our-advantages__list-item"], styles["our-advantages__list-item-documnets"])}>
                <AdvantagesDocumentsCard className={cn(styles["card-background"], styles["card-background-second"])} text={t("our_advantages_documents.2.text")} optionText={{
              ...
              <li className={cn(styles["our-advantages__list-item"], styles["our-advantages__list-item-documnets"])}>
                <AdvantagesDocumentsCard className={cn(styles["card-background"], styles["card-background-third"])} text={t("our_advantages_documents.3.text")} optionText={{
              ...
              <li className={cn(styles["our-advantages__list-item"], styles["our-advantages__list-item-documnets"])}>
                <AdvantagesDocumentsCard className={cn(styles["card-background"], styles["card-background-fourth"])} text={t("our_advantages_documents.4.text")} optionText={{
