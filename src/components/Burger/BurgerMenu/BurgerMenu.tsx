    ...
    <nav className={cn(styles["burger-menu"], className)}>
      <div className={cn(styles["burger-container"])}>
        ...
        <ul onClick={() => setBurgerMenu()} className={cn(styles["burger-menu__list-of-links"])}>
          ...
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.resume}>{t("footer_links.cv_writing")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.prepareToTest}>{t("footer_links.prepare_to_technical_language_test")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.students}>{t("footer_links.admission_to_universities")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.consultation}>{t("footer_links.personal_consultation")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.speakingClub}>{t("footer_links.conversational_club")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
            <Link className={cn(styles["burger-menu__link"])} href={routes.freeCourse}>{t("footer_links.free_information_course")}</Link>
          </li>
          <li className={cn(styles["burger-menu__list-item"])}>
        ...
        <ul onClick={() => setBurgerMenu()} className={cn(styles["burger-menu__list-of-documents"])}>
          ...
          <li>
            <Link className={cn(styles["burger-menu__link"])} href="/">Политика конфиденциальности</Link>
          </li>
        </ul>
