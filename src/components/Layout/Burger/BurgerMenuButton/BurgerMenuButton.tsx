  ...
  return (
    <div className={cn(styles["menu-button"])}>
      <div className={cn(styles["menu-button__desktop"])}>
        <button onClick={() => setDesktopNavMenu(!desktopNavMenu)} className={cn(styles["menu-button__desktop-button"])}>
          <span className={cn(styles["menu-button__desktop-button-text"])}>{t("service")}</span>
          <div className={cn(
